...
Esta adaptação usa como ponto de partida a skill MCP Market
`desktop-framework-electron`, substituindo convenções de Antigravity/Claude
pelas convenções do Codex e pelos contratos do Lex Editor.
