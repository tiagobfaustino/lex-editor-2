...
- [ ] T011-01 Normatizar em `DATA_MODEL.md` os contratos de
...
- [ ] T011-02 Criar migrations e repositórios para revisões imutáveis, ponteiro
  ativo, frequência, saúde e eventos append-only, com concorrência otimista e
  uma única revisão ativa por vínculo.
- [ ] T011-03 Implementar funções/serviço server-side que derivem o ator,
...
- [ ] T011-04 Criar o registro tipado de adaptadores instalados e o vocabulário
  declarativo limitado de origem/detecção, rejeitando regex, seletores,
  templates e opções desconhecidas.
- [ ] T011-05 Extrair fetch e adaptador Planalto para a biblioteca Node
...
- [ ] T011-06 Implementar dry-run pelo caminho real de ingestão, com resultado
...
- [ ] T011-07 Implementar casos de uso de criar revisão, testar, ativar, pausar,
  arquivar e restaurar, preservando histórico e falhando fechado em conflito.
- [ ] T011-08 Resolver a revisão ativa na importação por URL, selecionar o
...
- [ ] T011-13 Substituir o placeholder por listagem acessível de provedores e
  vínculos, exibindo revisão, ativação, saúde, frequência, última verificação e
  ações permitidas sem expor dados internos.
- [ ] T011-14 Implementar formulário orientado às capacidades do adapter e os
